...
export class SystemService {
  ...
  public enableDisable(system: System): Observable<System> {
    const params = JSON.stringify(system);
    const headers = new HttpHeaders().set('Content-type', 'application/json');
    return this.httpClient.post<System>(`${this.systemUrl}/enableDisable`, params, {headers: headers});
  }
